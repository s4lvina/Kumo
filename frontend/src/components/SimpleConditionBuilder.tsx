...
import { CONDITIONS, LOGICAL_OPERATORS } from '@/data/conditions'
...
/**
 * Constructor simplificado de condiciones que funciona con el sistema existente
 */
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Construye condiciones usando indicadores técnicos
          </p>
        </div>
        <Button
          onClick={addNewRule}
